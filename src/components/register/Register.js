        ...
        >
          <Container className="col-md-8 col-lg-8 col-sm-10">
            <Form>
              ...
              <Row>
                <Form.Group as={Col} md="6" sm="12" className="input-form1" controlId="validationCustom01">
                  <Form.Control
                    required
                    type="text"
                ...
                <Form.Group as={Col} md="6" sm="12" className="input-form2" controlId="validationCustom01">
                  <Form.Control
                    required
                    type="text"
